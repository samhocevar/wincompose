...
Download latest: [WinCompose 0.7.2](https://github.com/samhocevar/wincompose/releases/download/v0.7.2/WinCompose-Setup-0.7.2.exe) (March 18, 2015)
-----------------------------------

Installable version: [WinCompose 0.7.2 (installer)](https://github.com/samhocevar/wincompose/releases/download/v0.7.2/WinCompose-Setup-0.7.2.exe).

Portable version: [WinCompose 0.7.2 (portable)](https://github.com/samhocevar/wincompose/releases/download/v0.7.2/WinCompose-NoInstall-0.7.2.zip).
